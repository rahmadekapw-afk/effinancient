...
<head>
    ...
    <style>
        ...
        .active-link {
            ...
            border-right: 4px solid #d1fae5; /* emerald-100 */
        }
        
        /* Default Desktop: Sidebar terbuka */
        #main-content-admin, #main-header-admin {
        ...
        .sidebar-closed #main-content-admin, .sidebar-closed #main-header-admin {
            margin-left: 0;
            width: 100%; /* Konten utama melebar 100% */
        }
 ...
 {{-- notif swich alert --}}
    ...
    <aside id="sidebar-admin" class="sidebar-bg text-white w-64 h-screen fixed top-0 left-0 z-40">
        ...
        <nav class="mt-2 overflow-y-auto h-[calc(100vh-14rem)]">
            ...
            <a href="{{ url('/admin/manajemen_anggota') }}" 
            class="flex items-center gap-3 px-6 py-3 transition-colors 
            ...
            <a href="{{ url('/admin/laporan_keuangan') }}" 
            class="flex items-center gap-3 px-6 py-3 transition-colors 
            ...
            <a href="{{ url('/admin/manajemen_akses') }}" 
            class="flex items-center gap-3 px-6 py-3 transition-colors 
    ...
    </aside> <div id="sidebar-overlay-admin" class="fixed inset-0 bg-black bg-opacity-50 z-30 hidden md:hidden"></div>

    <div id="main-content-admin">
        
        <header id="main-header-admin" class="fixed top-0 left-0 bg-white h-14 flex items-center justify-between px-4 md:px-6 z-30 shadow-sm">
