...
<body class="bg-green-50 text-gray-800">
    ...
    <div class="min-h-screen flex flex-col justify-center items-center p-4">
        ...
        <main class="bg-white p-6 sm:p-8 rounded-2xl shadow-xl w-full max-w-md">
            ...
            <div class="flex mb-6">
                <button id="tab-anggota" class="tab-btn flex-1 py-3 px-4 rounded-lg font-semibold flex items-center justify-center gap-2 transition-all duration-300 bg-white text-green-600 shadow-md">
                    <i class="bi bi-person-fill"></i>
                    Anggota
                </button>
                
                <button id="tab-admin" class="tab-btn flex-1 py-3 px-4 rounded-lg font-semibold flex items-center justify-center gap-2 transition-all duration-300 text-gray-500 hover:bg-gray-100">
            ...
            <div id="content-anggota" class="tab-content">
                ...
                <form action="#">
                    ...
                    <p class="text-center text-sm text-gray-600 mt-6">
                        Belum punya akun? <a href="#" class="font-medium text-green-600 hover:underline">Daftar sekarang</a>
                    </p>
                </form>
            </div>
            ...
            <div id="content-admin" class="tab-content" style="display: none;">
                ...
                <form action="#">
                    ...
                    <div class="mb-4">
                        <label for="password-admin" class="block text-sm font-medium text-gray-700 mb-1">Password</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3">
                                <i class="bi bi-lock text-gray-400"></i>
                            </span>
                    ...
                    <div class="flex items-center justify-between mt-4">
                        <div class="flex items-center">
                            <input id="remember-admin" name="remember" type="checkbox" class="h-4 w-4 text-green-600 border-gray-300 rounded focus:ring-green-600">
